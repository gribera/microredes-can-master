class Consts():
    ...
    disp_origen = {'Broadcast': '0x00', 'Master': '0x01'}

    disp_destino = {'Equipo 2': '0x02', 'Equipo 3': '0x03', 'Equipo 4': '0x04'}
    ...
    def get_disp_origen(self):
        return self.disp_origen

    def get_disp_destino(self):
        return self.disp_destino
